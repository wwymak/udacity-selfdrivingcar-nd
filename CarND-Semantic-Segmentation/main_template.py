...
# thses are the hyperparms that can be tuned. So far, these seems to be a reasonable set of values
# mean iou on training set around 88% and loss has 'flattened out' by epoch 10 or so
# and give fairly good results on the test set
