            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    for (int i =0; i< ptsx.size(); i++) {
                        ...
                        //then rotate
                        ptsx.at(i) = car_x * cos(0 - psi) - car_y * sin(0 -psi);
                        ptsy.at(i) = car_x * sin(0 - psi) + car_y * cos(0 -psi);

                        ptsx_vector[i] = ptsx.at(i);
                        ptsy_vector[i] = ptsy.at(i);
                    }
                    ...
                    for (int i = 2; i < vars.size(); i++) {
                        if(i % 2 == 0){
                            ...
                            mpc_y_vals.push_back(vars.at(i));
                        }
                    }
